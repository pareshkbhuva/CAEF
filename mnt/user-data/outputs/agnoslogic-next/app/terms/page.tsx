    ...
    <>
      ...
      <section className="legal">
        <div className="container-prose">
          ...
          <p>
            By accessing or using AgnosLogic (the &quot;Service&quot;) operated by Agnos Research, you agree to these Terms of Service. If you do not agree, do not use the Service.
          </p>
          ...
          <p>
            AgnosLogic, its architecture (CAEF), and all related technology are owned by Agnos Research and protected by a US Provisional Patent filed March 23, 2026. You retain ownership of content you submit to the Service.
          </p>

          <h2>Liability</h2>
          <p>
            To the fullest extent permitted by law, Agnos Research is not liable for any indirect, incidental, special, or consequential damages arising from your use of the Service. Our total liability for any claim shall not exceed the fees you paid in the 12 months preceding the claim.
          </p>
